...
//joka tulostaa koko bookArrayn konsolille (huom! this-osoitin)
getAllBooks: function() {
    console.log(this.bookArray);
},


//joka tulostaa sille argumenttina(x:n arvo) annetun kirjan tiedot
getOneBook(x){
console.log(this.bookArray[x]);
},


//joka lisää sille annetun kirjan bookArrayhin (käytä push metodia)
...
book.addBook(4, "My New Book", "Me", "1234567890");

console.log("UUSI LISTA");
book.getAllBooks();